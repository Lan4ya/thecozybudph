...
const MissionSection = ({ registerSentinel, visibleMap, index }: MissionSectionProps) => {
  return (
    <section className="custom-container py-16 lg:py-24">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          Our mission is to deliver fresh, high-quality flowers and create beautiful
          arrangements that make every occasion memorable. We believe in sustainable
          sourcing, supporting local growers, and crafting designs that capture the
